...
const styles = "/assets/styles-Bah_XQrh.css";
...
const $$splitComponentImporter$7 = () => import("./login-TJ4zap-R.mjs");
objectType({
...
const $$splitComponentImporter$6 = () => import("../_authenticated-2Pb5qX1b.mjs");
...
const SelectContent = reactExports.forwardRef(({ className, children, position = "popper", ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectPortal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
  SelectContent$1,
  {
    ref,
    className: cn(
      "relative z-[100] max-h-72 min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-[var(--shadow-elegant)] data-[state=open]:animate-in data-[state=open]:fade-in-0",
...
const $$splitComponentImporter$5 = () => import("../_authenticated.prospeccao-B7BXmS4S.mjs");
const Route$5 = createFileRoute("/_authenticated/prospeccao")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("../_authenticated.projetos-DbZoXELR.mjs");
const Route$4 = createFileRoute("/_authenticated/projetos")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("../_authenticated.prestadores-DNIgwZ9O.mjs");
const Route$3 = createFileRoute("/_authenticated/prestadores")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_authenticated.meu-perfil-Cyazi1wk.mjs");
const Route$2 = createFileRoute("/_authenticated/meu-perfil")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_authenticated.dashboard-4QqDbd8T.mjs");
const Route$1 = createFileRoute("/_authenticated/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_authenticated.admin-CVU4AhiV.mjs");
