...
import { c as cn } from "./router-AKv_mo6E.mjs";
const Card = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "div",
  {
    ref,
    className: cn(
      "rounded-xl border border-border/60 bg-card text-card-foreground shadow-[var(--shadow-soft)]",
      className
    ),
    ...props
  }
...
const CardHeader = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: cn("flex flex-col gap-1.5 p-6", className), ...props }));
