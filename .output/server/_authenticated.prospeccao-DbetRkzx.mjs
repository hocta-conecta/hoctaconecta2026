...
import { B as Button, s as supabase, D as Dialog, a as DialogContent, b as DialogHeader, d as DialogTitle, c as cn, T as Textarea, i as DialogFooter, j as Badge, S as Select, e as SelectTrigger, f as SelectValue, g as SelectContent, h as SelectItem } from "./_ssr/router-C2dLdX7v.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: form.handleSubmit((v) => save.mutate(v)), className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CidadeSingleCombobox, { uf: ufSede, value: cidadeSede, onChange: setCidadeSede })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
