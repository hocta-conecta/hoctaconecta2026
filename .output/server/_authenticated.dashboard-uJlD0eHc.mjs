...
import { j as Badge, c as cn, s as supabase } from "./_ssr/router-lpyZtYZ-.mjs";
import { C as Card, a as CardHeader, c as CardTitle, d as CardDescription, b as CardContent } from "./_ssr/card-De6J-a9I.mjs";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./_ssr/tabs-LPIfJtPi.mjs";
...
function DashboardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl sm:text-3xl font-bold tracking-tight", children: "Dashboard Corporativo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-muted-foreground mt-1", children: "Visão geral e KPIs consolidados da rede prestadora" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Total Prestadores", value: data?.totalPrestadores ?? 0, icon: Users, tone: "primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Especialidades cobertas", value: data?.totalEspecialidadesCobertas ?? 0, icon: Sparkles, tone: "accent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Prospecções Ativas", value: data?.totalProspectos ?? 0, icon: Target, tone: "warning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Credenciados", value: data?.credenciados ?? 0, icon: CircleCheck, tone: "success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Taxa de Conversão", value: `${data?.taxaConversao ?? 0}%`, icon: TrendingUp, tone: "accent", subtitle: "Prospecção → Credenciado" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "planejamento", className: "w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "planejamento", className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Credenciados por Especialidade" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Distribuição real da rede credenciada" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: data?.porEspecialidade.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { mensagem: "Nenhum credenciado registrado ainda." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, className: "sm:!h-[300px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: data?.porEspecialidade, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "credenciados", fill: "#27AE60", name: "Credenciados" })
          ] }) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Prestadores por Município" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Quantidade de prestadores cadastrados por cidade" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: data?.coberturaMunicipios.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { mensagem: "Nenhum prestador com cidade registrada." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2", children: data?.coberturaMunicipios.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate", children: m.municipio }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-primary mt-2", children: m.total }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "prestadores" })
          ] }, m.municipio)) }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "metas", className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Top prestadores multi-especialidade" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Concentração estratégica de cobertura" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: data?.prestadoresMulti.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { mensagem: "Cadastre prestadores e vincule especialidades." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: data?.prestadoresMulti.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate", children: p.nome }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-muted rounded-full overflow-hidden mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-primary", style: {
                width: `${Math.min(100, p.n / Math.max(1, data.prestadoresMulti[0].n) * 100)}%`
              } }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: p.n >= 3 ? "success" : "secondary", children: [
              p.n,
              " esp."
            ] })
          ] }, p.nome)) }) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "prospeccao", className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Funil de Etapas" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Prospecções em andamento por etapa" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: data?.porEtapa.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { mensagem: "Nenhuma prospecção registrada." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, className: "sm:!h-[300px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: data?.porEtapa, layout: "vertical", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", opacity: 0.2 }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "#1558a8", radius: [0, 6, 6, 0] })
            ] }) }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Ranking de Executivos" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Performance em prospecções e credenciamentos" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: data?.rankingExecutivos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { mensagem: "Nenhum executivo com prospecções vinculadas." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: data?.rankingExecutivos.map((exec, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 flex items-center justify-center h-8 w-8 rounded-full bg-primary/10 text-primary font-semibold text-sm", children: idx + 1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-sm", children: exec.nome }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Prospecções em andamento (excluídos credenciados e declinados)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: data?.prestadoresAtivos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { mensagem: "Nenhuma prospecção ativa no momento." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "border-b", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-3 font-medium", children: "Prestador" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-3 font-medium", children: "Especialidade" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-3 font-medium", children: "Etapa" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: data?.prestadoresAtivos.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b hover:bg-muted/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-3", children: r.nome }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-3", children: r.especialidade }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: r.etapa }) })
            ] }, i)) })
          ] }) }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "credenciamento", className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Evolução de Credenciamentos" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Meses do ano atual" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: data?.credenciamentosPorMes.every((m) => m.count === 0) ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { mensagem: "Nenhum credenciamento registrado este ano." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, className: "sm:!h-[300px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: data?.credenciamentosPorMes, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "colorCred", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: "#27AE60", stopOpacity: 0.8 }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "count", name: "Credenciados", stroke: "#27AE60", fillOpacity: 1, fill: "url(#colorCred)" })
            ] }) }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Prestadores Credenciados Recentes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Rede credenciada ativa — últimos credenciados" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: data?.prestadoresCredenciados.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { mensagem: "Nenhum prestador credenciado ainda." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: data?.prestadoresCredenciados.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg hover:bg-muted/50 transition", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-sm", children: p.nome }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: p.especialidade }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-success mt-2", children: [
              "Credenciado em ",
              p.data
            ] })
          ] }, i)) }) })
...
function KpiCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground truncate", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl sm:text-3xl font-bold tracking-tight mt-1", children: value }),
      subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2 truncate", children: subtitle })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("h-10 w-10 sm:h-12 sm:w-12 rounded-lg flex items-center justify-center flex-shrink-0", toneClass), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5 sm:h-6 sm:w-6" }) })
  ] }) }) });
}
export {
